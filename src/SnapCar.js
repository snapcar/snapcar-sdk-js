...
console.log(SnapCar.APIError.mapping);
   ...
   /**
    ...
    SnapCar.performAPICall = function (requestParams, resultProcessor, checkToken) {
        ...
        var xhr = $.ajax(requestParams).done(function (data) {
     ...
     * @method abortRequest
     * @for SnapCar
     * @param {jQuery.Promise} The jQuery promise associated to the request to be cancelled.
     */

    SnapCar.abortRequest = function(promise) {
        promise._abort();
    };
